...
<section className={`${themeClasses.cardBg} rounded-xl shadow-md border ${themeClasses.border} p-4 mb-4`}>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
    {campaign.promotions.map((promo, index) => (
      <div
        key={index}
        className={`${themeClasses.cardBg} rounded-xl p-4 text-center border ${themeClasses.border} shadow-md transition-transform transform hover:scale-[1.02] duration-200`}
      >
        {/* Quantidade de cotas */}
