...
const handleQuotaSelect = useCallback((quotaNumber: number) => {
  ...
  setSelectedQuotas(prev => {
    ...
    if (prev.includes(quotaNumber)) {
      ...
      return newSelectionState; // Retorna aqui
    } else {
      newSelectionState = [...prev, quotaNumber];
      const maxLimit = campaign.max_tickets_per_purchase || 20000;
      ...
      return prev; // Retorna aqui
    }
    // O return final `return newSelectionState;` é inalcançável e pode ser removido.
    // No entanto, a lógica já está retornando nos blocos if/else.
  });
