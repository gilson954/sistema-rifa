            ...
            <div className={`${themeClasses.cardBg} rounded-2xl shadow-xl p-6 border ${themeClasses.border}`}>
              ...
              {campaign.prize_image_urls && campaign.prize_image_urls.length > 0 && (
                <div className="relative w-full h-80 rounded-lg overflow-hidden mb-6">
                  ...
                  {campaign.draw_date && (
                    <div className="absolute bottom-4 left-4 bg-gray-900 bg-opacity-90 text-white px-3 py-2 rounded-lg font-bold text-sm sm:text-base flex items-center space-x-2 shadow-lg">
                  ...
                  <div className="absolute bottom-4 right-4 bg-purple-600 bg-opacity-90 text-white px-3 py-2 rounded-lg font-bold text-sm sm:text-base flex items-center space-x-2 shadow-lg">
              ...
              <div className={`${themeClasses.cardBg} rounded-2xl shadow-xl p-6 border ${themeClasses.border}`}>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <p className="text-lg font-semibold">
                    Data: {formatDrawDateForButton(campaign.draw_date)}
                  </p>
                </div>
              </div>
            )}
