...
import { motion, AnimatePresence } from 'framer-motion'; // Importações mantidas
...
interface CampaignFormData {
    description: string;
    requireEmail: boolean; // Checkbox animado aqui
    showRanking: boolean; // Checkbox animado aqui
    minTicketsPerPurchase: number;
    maxTicketsPerPurchase: number;
    drawDate: Date | null;
    ticketPrice: number;
    totalTickets: number;
    acceptCampaignTerms: boolean; // Checkbox animado aqui
    // ... outros campos necessários
}

// Componente reusável para o Checkbox Animado
...
const AnimatedCheckbox: React.FC<AnimatedCheckboxProps> = ({ id, checked, onChange, label }) => {
  return (
    <motion.div 
    ...
    >
        <label htmlFor={id} className="flex items-start gap-3 cursor-pointer group">
            ...
            <span className="text-base font-medium text-gray-900 dark:text-white leading-relaxed cursor-pointer">
                {label}
            </span>
        </label>
    </motion.div>
      ...
      <main className="max-w-4xl mx-auto bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 sm:p-10">
        ...
        <form onSubmit={handleSaveAndContinue} className="space-y-8">
            ...
            <div className="space-y-6 pt-6 border-t dark:border-gray-700">
                ...
                {/* Configurações de Checkbox/Switch - USANDO AnimatedCheckbox */}
