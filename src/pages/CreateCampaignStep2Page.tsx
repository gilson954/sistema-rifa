...
const CreateCampaignStep2Page = () => {
  ...
  if (!campaign) {
    return (
      <div className="rounded-xl sm:rounded-2xl p-4 sm:p-6 text-center border border-gray-200/20 dark:border-gray-800/30 bg-white/60 dark:bg-gray-900/50 backdrop-blur-sm">
        <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">Campanha não encontrada.</p>
      </div>
    );
  }
    ...
    <div className="dashboard-page min-h-screen bg-transparent text-gray-900 dark:text-white transition-colors duration-300">
      ...
      <main className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        >
          ...
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            <div className="flex items-center space-x-1.5 sm:space-x-2">
              ...
              <span className="text-xs sm:text-sm font-bold text-purple-600 dark:text-purple-400">Detalhes</span>
            </div>
            <div className="flex-1 h-1 bg-gray-200 dark:bg-gray-700 rounded-full"></div>
            <div className="flex items-center space-x-1.5 sm:space-x-2">
              <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center text-gray-500 text-xs sm:text-sm font-bold">
                3
              </div>
              <span className="text-xs sm:text-sm text-gray-500">Pagamento</span>
            </div>
          </div>
        </motion.div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
          ...
          {errors.submit && (
            <motion.div 
              className="rounded-xl sm:rounded-2xl p-3 sm:p-5 border border-red-200/20 dark:border-red-800/30 bg-red-50/60 dark:bg-red-900/20 backdrop-blur-sm"
              initial={{ opacity: 0, scale: 0.95 }}
              animate={{ opacity: 1, scale: 1 }}
              transition={{ duration: 0.3 }}
            >
              <div className="flex items-center space-x-2 sm:space-x-3">
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-red-600 rounded-lg sm:rounded-xl flex items-center justify-center flex-shrink-0 shadow-md">
                  <AlertTriangle className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
                </div>
                <p className="text-xs sm:text-base text-red-700 dark:text-red-300 font-medium">{errors.submit}</p>
              </div>
            </motion.div>
          )}
          ...
          <motion.div 
            className="rounded-xl sm:rounded-2xl border border-gray-200/20 dark:border-gray-700/30 bg-white/70 dark:bg-gray-900/60 backdrop-blur-sm overflow-hidden"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.4, delay: 0.1 }}
          >
            <div className="flex items-center space-x-2 sm:space-x-3 p-3 sm:p-5 border-b border-gray-200/20 dark:border-gray-700/30">
              <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl animate-gradient-x bg-[length:200%_200%] bg-gradient-to-r from-purple-600 via-pink-500 to-blue-600 flex items-center justify-center shadow-md">
          ...
          >
            <div className="flex items-center space-x-2 sm:space-x-3 p-3 sm:p-5 border-b border-gray-200/20 dark:border-gray-700/30">
              <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-blue-600 flex items-center justify-center shadow-md">
          ...
          >
            <div className="flex items-center justify-between p-3 sm:p-5 border-b border-gray-200/20 dark:border-gray-700/30">
              <div className="flex items-center space-x-2 sm:space-x-3">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-purple-600 flex items-center justify-center shadow-md">
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-5 py-1.5 sm:py-2.5 text-xs sm:text-sm rounded-lg sm:rounded-xl font-bold shadow-md transition-all duration-300 hover:-translate-y-0.5 animate-gradient-x bg-[length:200%_200%] bg-gradient-to-r from-purple-600 via-pink-500 to-indigo-600 text-white"
              >
            ...
            <div className="p-3 sm:p-6">
              {promotions.length > 0 ? (
                <div className="space-y-2 sm:space-y-3">
                  {promotions.map((promo, index) => {
                    ...
                    return (
                      <motion.div
                        key={promo.id}
                        className="rounded-lg sm:rounded-xl p-3 sm:p-5 border border-purple-100/20 dark:border-purple-900/30 bg-purple-50/50 dark:bg-purple-900/10 backdrop-blur-sm hover:shadow-md transition-all duration-300"
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center space-x-2 sm:space-x-3 text-xs sm:text-sm mb-1 sm:mb-2 flex-wrap">
                              ...
                              <span className="text-green-600 dark:text-green-400 font-bold text-xs sm:text-base">
                                {formatCurrency(promo.discountedTotalValue)}
                              </span>
                            </div>
                            <div className="inline-flex items-center px-2 sm:px-3 py-0.5 sm:py-1 bg-green-100 dark:bg-green-900/30 rounded-full">
                          ...
                          <button
                            ...
                            className="p-2 sm:p-3 text-red-600 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-900/30 rounded-lg sm:rounded-xl transition-all duration-200"
                          >
                ...
                <div className="rounded-lg sm:rounded-xl p-8 sm:p-12 text-center border-2 border-dashed border-gray-300 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/50">
          ...
          >
            <div className="flex items-center justify-between p-3 sm:p-5 border-b border-gray-200/20 dark:border-gray-700/30">
              <div className="flex items-center space-x-2 sm:space-x-3">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-yellow-600 flex items-center justify-center shadow-md">
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-5 py-1.5 sm:py-2.5 text-xs sm:text-sm rounded-lg sm:rounded-xl font-bold shadow-md transition-all duration-300 hover:-translate-y-0.5 bg-green-600 hover:bg-green-700 text-white"
              >
                <Plus className="h-3 w-3 sm:h-4 sm:w-4" />
                Adicionar
              </button>
              ...
              {prizes.length > 0 ? (
                <div className="space-y-2 sm:space-y-3">
                  {prizes.map((prize, index) => (
                    <motion.div
                      key={prize.id}
                      className="rounded-lg sm:rounded-xl p-3 sm:p-5 border border-yellow-100/20 dark:border-yellow-900/30 bg-yellow-50/50 dark:bg-yellow-900/10 backdrop-blur-sm hover:shadow-md transition-all duration-300"
                      initial={{ opacity: 0, x: -20 }}
                      animate={{ opacity: 1, x: 0 }}
                      transition={{ duration: 0.3, delay: index * 0.1 }}
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3 sm:space-x-4">
                          <div className="w-10 h-10 sm:w-12 sm:h-12 bg-yellow-600 rounded-lg sm:rounded-xl flex items-center justify-center shadow-md">
                            <span className="text-white font-bold text-sm sm:text-lg">
                              {index + 1}º
                            </span>
                          </div>
                          <span className="text-sm sm:text-lg text-gray-900 dark:text-white font-medium">
                            {prize.name}
                          </span>
                        </div>
                        <button
            ...
            <div className="p-3 sm:p-6">
              <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-4 sm:mb-6">
                <button
                  ...
                  className={`py-3 sm:py-4 px-3 sm:px-6 text-xs sm:text-base rounded-lg sm:rounded-xl font-bold transition-all duration-300 border-2 ${
              ...
              {formData.showDrawDateOption === 'show-date' && (
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full px-3 sm:px-5 py-3 sm:py-4 text-xs sm:text-base border-2 rounded-lg sm:rounded-xl bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 hover:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 border-gray-300 dark:border-gray-600 font-medium shadow-sm text-left cursor-pointer hover:shadow-md"
                  >
                    <div className="flex items-center justify-between">
              ...
              {formData.showDrawDateOption === 'no-date' && (
                <motion.div 
                  className="rounded-lg sm:rounded-xl p-8 sm:p-12 text-center border-2 border-dashed border-gray-300 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/50"
                  initial={{ opacity: 0, scale: 0.95 }}
                  animate={{ opacity: 1, scale: 1 }}
                  transition={{ duration: 0.3 }}
                >
                  <Calendar className="h-12 w-12 sm:h-16 sm:w-16 text-gray-400 mx-auto mb-2 sm:mb-3" />
                  <p className="text-sm sm:text-base text-gray-500 dark:text-gray-400 font-medium">
          ...
          >
            <div className="flex items-center space-x-2 sm:space-x-3 p-3 sm:p-5 border-b border-gray-200/20 dark:border-gray-700/30">
              <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-gray-700 flex items-center justify-center shadow-md">
            ...
            <div className="p-3 sm:p-6 space-y-4 sm:space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full appearance-none px-3 sm:px-5 py-3 sm:py-4 text-xs sm:text-base border-2 rounded-lg sm:rounded-xl bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200 border-gray-300 dark:border-gray-600"
                  >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    min="1"
                    className={`w-full px-3 sm:px-5 py-3 sm:py-4 text-xs sm:text-base border-2 rounded-lg sm:rounded-xl bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200 ${
                      errors.minTicketsPerPurchase ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'
                    }`}
                  />
                  {errors.minTicketsPerPurchase && (
                    <p className="text-red-500 text-xs sm:text-sm mt-2 flex items-center space-x-1">
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    onChange={handleInputChange}
                    className={`w-full appearance-none px-3 sm:px-5 py-3 sm:py-4 text-xs sm:text-base border-2 rounded-lg sm:rounded-xl bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200 ${
                ...
                {/* Preview Image */}
                <motion.div 
                  className="mt-3 sm:mt-4 rounded-lg sm:rounded-xl overflow-hidden border-2 border-gray-200/30 dark:border-gray-700/30 bg-gradient-to-br from-gray-50/50 to-gray-100/50 dark:from-gray-800/50 dark:to-gray-900/50 p-2 sm:p-3"
                  initial={{ opacity: 0, scale: 0.95 }}
                  animate={{ opacity: 1, scale: 1 }}
                  transition={{ duration: 0.3 }}
                >
                ...
                {campaignModelError && (
                  <motion.div 
                    className="mt-2 sm:mt-3 flex items-start space-x-2 sm:space-x-3 rounded-lg sm:rounded-xl p-3 sm:p-4 border border-orange-200/20 dark:border-orange-800/30 bg-orange-50/60 dark:bg-orange-900/20 backdrop-blur-sm"
                    initial={{ opacity: 0, y: -10 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.3 }}
                  >
                    <div className="w-6 h-6 sm:w-8 sm:h-8 bg-orange-600 rounded-lg flex items-center justify-center flex-shrink-0 shadow-md">
                      <AlertTriangle className="h-3 w-3 sm:h-4 sm:w-4 text-white" />
                    </div>
                    <span className="text-orange-800 dark:text-orange-200 text-xs sm:text-sm font-medium pt-0.5 sm:pt-1">
                      {campaignModelError}
                    </span>
                  </motion.div>
                )}
              ...
              {/* Checkboxes Section */}
              <div className="space-y-2 sm:space-y-3 pt-3 sm:pt-4 border-t-2 border-gray-200/20 dark:border-gray-700/30">
                <motion.div 
                  className="flex items-center p-3 sm:p-4 rounded-lg sm:rounded-xl border border-green-100/20 dark:border-green-900/30 bg-green-50/30 dark:bg-green-900/10 backdrop-blur-sm hover:border-green-300/50 dark:hover:border-green-700/50 transition-all duration-200"
                ...
                >
                  <label className="flex items-center cursor-pointer flex-1">
                    ...
                    />
                    <motion.div 
                      className={`w-4 h-4 sm:w-5 sm:h-5 rounded-lg flex items-center justify-center ${formData.showPercentage ? 'bg-green-600 border-green-600' : 'border-2 border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800'}`}
                    ...
                    <span className="ml-3 sm:ml-4 text-xs sm:text-sm text-gray-700 dark:text-gray-300 font-medium">
          ...
          >
            <button
              ...
              className="inline-flex items-center gap-2 sm:gap-3 px-6 sm:px-10 py-3 sm:py-4 text-sm sm:text-lg rounded-lg sm:rounded-xl font-bold shadow-lg transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:transform-none animate-gradient-x bg-[length:200%_200%] bg-gradient-to-r from-[#7928CA] via-[#FF0080] via-[#007CF0] to-[#FF8C00] text-white"
            >
              {loading ? (
                <>
                  <div className="animate-spin rounded-full h-4 w-4 sm:h-6 sm:w-6 border-3 border-white border-t-transparent"></div>
