  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        animate={{
          backgroundColor: checked ? config.checkboxColor : (color === 'blue' ? 'rgb(255, 255, 255)' : 'rgb(255, 255, 255)'), // Fundo branco quando desmarcado
          borderColor: checked ? 'transparent' : 'rgb(209, 213, 219)', // Cor de borda cinza quando desmarcado
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="rounded-2xl border border-gray-200/20 dark:border-gray-700/30 bg-white/70 dark:bg-gray-900/60 backdrop-blur-sm overflow-hidden">
            ...
            <div className="p-6 space-y-6">
              ...
              {/* Checkboxes Section - SUBSTITUÍDO PELOS COMPONENTES ANIMADOS */}
