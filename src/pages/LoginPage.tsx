        ...
        >
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {/* Submit - botão com onda infinita */}
              <motion.button
                type="submit"
                disabled={loading}
                className="relative w-full text-white py-3 rounded-lg font-semibold transition flex items-center justify-center shadow-lg shadow-purple-500/30 overflow-hidden"
                ...
                style={{
                  background:
                    "linear-gradient(270deg, #ec4899, #8b5cf6, #3b82f6, #ec4899)", // rosa → roxo → azul → rosa
