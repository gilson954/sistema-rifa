          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3 rounded-lg font-semibold text-white shadow-lg shadow-purple-500/30 overflow-hidden
                           animate-gradient-button disabled:opacity-50 flex items-center justify-center"
              >
                {loading ? (
