...
const SuggestionsPage = () => {
  ...
  // Variantes de Animação (Inspiradas em AccountPage.tsx)
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 sm:gap-4">
                  {feedbackTypes.map((type) => {
                    ...
                    return (
                      <motion.button // Aplicando motion.button
                        key={type.value}
                        type="button"
                ...
                {!selectedFile ? (
                  <div className="relative">
                    <input
                      ...
                      className="hidden"
                    />
                    <motion.label // Aplicando motion.label
                      htmlFor="file-upload"
                  ...
                  <motion.div // Aplicando motion.div
