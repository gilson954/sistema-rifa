...
const QuotaSelector: React.FC<QuotaSelectorProps> = ({
  ...
  return (
    <div className={`quota-selector rounded-2xl shadow-2xl p-6 border transition-all duration-300 ${theme.cardBg} ${theme.border}`}>
      ...
      {/* Quantity Input - Design mais escuro */}
      <div className="flex items-center justify-center mb-5">
        ...
        `}>
          ...
          >
            <Minus className="size-5" strokeWidth={3.5} />
          </button>
      ...
      <div className="text-center mb-5">
        <div 
          className={`inline-block text-xs font-semibold px-3 py-1 rounded-full ${theme.textSecondary} bg-gray-700/30`}
        >
      ...
      {/* Total Value - Fundo mais escuro */}
      <div className={`text-center mb-5 mt-6 p-5 rounded-xl ${theme.inputBg} border ${theme.border} shadow-inner`}>
        {promotionInfo && (
          <div className="mb-2">
        ...
        <div className={`text-xs font-semibold ${theme.textSecondary} mb-1.5 tracking-wider uppercase`}>
          Valor Total
        </div>
        <div 
